$(function() {
    ...
    function c() {
        ...
        if (k) {
            ...
            var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height='+(document.documentElement.clientHeight-130)+' src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
			 }else{
    ...
    function closethis() {
        $(".page-tabs-content").children("[data-id].active").each(function() {
            $('.J_iframe[data-id="' + $(this).data("id") + '"]').remove();
            $(this).remove()
        });
    ...
    $(".J_tabClosethis").on("click", closethis);
