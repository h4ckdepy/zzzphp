      ...
      <form method="post" action="save.php?act=admingroup" class="form-horizontal" id="contentform">
          ...
          <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" value="[r:g_name]" name="g_name" data-required="*" id="g_name" class="form-control">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label  text-danger">组权限值</label>
                <div class="col-sm-10">
                  <input type="text" value="[r:g_mark]" data-required="*" name="g_mark" id="g_mark" class="form-control">
                </div>
              </div>
              <div class="form-group">
       ...
       <div class="col-sm-12  col-md-offset-1">
          ...
          <div class=" col-sm-10 col-md-offset-1">
            <button class="btn btn-primary" onclick="submitform('admingroup','[r:gid]','contentform')" type="button" id="submit" title="快捷键：ctrl+enter"><i class="fa fa-floppy-o"></i>　保存内容</button>
