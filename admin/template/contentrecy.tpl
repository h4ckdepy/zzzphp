          ...
          <div class="row">
            <div id="toolbar">
              <div class="col-sm-3">
                ...
                <button  onClick="location.href='?act=sortrecy'" class="btn btn-primary" type="button"><i class="fa fa-trash"></i> 分类回收站</button>
              </div>
              <div class="col-sm-3">
            ...
            <table {zzz:table50} data-url="function.php?act=recylist&type=content">
              <thead>
                <tr>
