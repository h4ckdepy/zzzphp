...
<div class="wrapper wrapper-content">
  <div class="ibox float-e-margins">      <div class="row row-lg"> 
          ...
          <button id="add" class="btn  btn-primary" type="button" onclick="opennew('?act=usergroup')"><i class="fa fa-plus"></i> 添加会员组</button>
          ...
          <button onClick="closetab()" class="btn" type="button"><i class="fa fa-reply"></i> 关闭</button></div>    
            <table {zzz:table50}  data-url="function.php?act=usergroup">
              <thead>
                <tr>
