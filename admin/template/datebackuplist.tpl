  ...
  <div class="ibox float-e-margins">
    <div class="ibox-content">
      <div class="row row-lg">
        <div class="col-sm-12">
          <div class="col-sm-7">
           <button id="add" class="btn  btn-primary" type="button" onclick="backup()"><i class="fa fa-save">　</i>备份数据库</button>
            ...
            <table {zzz:table50} data-url="function.php?act=databackup">         
            <thead>
              <tr>
             <th class="tablename" data-field="name" data-sortable="true">数据库</th>
                <th class="tablename" data-field="url" data-sortable="true">文件名称</th>
				<th class="tablename" data-field="size" data-sortable="true">大小</th>
                <th class="tablename" data-field="mtime" data-sortable="true">备份时间</th>
